...
function sDialog(t,c,w,left,top)
{
	...
	with(sharf_Dtop.style){zIndex = 999; backgroundColor = '#ff0000'; position = 'absolute'; width = w+'px'; left = sl+'px'; top = st+'px';}
...
//<input type="text" name="money" value="" onKeyPress="inputMoney(this)" onKeyUp="inputMoney(this)" onBlur="inputMoney(this)"/>
function inputMoney(o)
{
