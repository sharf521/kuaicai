...
define( "WB_AKEY" , '80360691' );
define( "WB_SKEY" , 'c0889d189c4319d3d0e52e7ab083da36' );

$my_url = "http://www.vcivc.cn/index.php?app=sina&id=$userid&mysite=$host";
...
$uid=$token['uid'];
header("location:http://".$mysite."/index.php?app=cart&act=xinlang&uid=$uid&userid=$userid");
exit;
