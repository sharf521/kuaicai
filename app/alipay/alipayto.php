...
$discount	 		= '';	
$youhuidiscount	 		= '';					//折扣，是具体的金额，而不是百分比。若要使用打折，请使用负数，并保证小数点最多两位数
$discount_jifen	 		= '';
$youhuidiscount_jifen	 		= '';
...
$parameter = array(
		...
		//扩展功能参数——其他
		"discount"			=> $discount,
		"youhuidiscount"			=> $youhuidiscount,
		"discount_jifen"			=> $discount_jifen,
		"youhuidiscount_jifen"			=> $youhuidiscount_jifen,
