...
class SwfuploadApp extends StoreadminbaseApp
{
    ...
    function SwfuploadApp()
    {
        ...
        {
            case BELONG_ARTICLE :   
			$this->save_path = 'data/files/'.intval($id/2000).'/shop_' . $this->store_id . '/article';
            break;
            case BELONG_STORE :     
			$this->save_path = 'data/files/'.intval($id/2000).'/shop_' . $this->store_id . '/other';
            break;
            case BELONG_GOODS :     
			$this->save_path = 'data/files/'.intval($id/2000).'/shop_' . $this->store_id .'/'. date('Ym');//'/goods_' . (time() % 200);
            break;
        }
