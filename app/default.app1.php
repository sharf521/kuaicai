...
$this->assign('recom20', $recom20);
	   ...
	   ");
		$img_goods_list1 = $recom_mod->get_recommended_goods(23, 4, true);
	   ...
	   ");
		$img_goods_list2 = $recom_mod->get_recommended_goods(20, 4, true);
	   ...
	   ");
		$img_goods_list3 = $recom_mod->get_recommended_goods(24, 4, true);
	   ...
	   $this->assign('adv_list5', $adv_list5);
		$img_goods_list4 = $recom_mod->get_recommended_goods(21, 4, true);
	   ...
	   ");
		...
		$img_goods_list5 = $recom_mod->get_recommended_goods(22, 4, true);
	...
	$time=date('Y-m-d H:i:s');
	 $this->adv_mod =& m('adv');
	   ...
	   $order_goods_mod =& m('ordergoods');
		...
		$this->assign('qrcode',qrcode($_SERVER['HTTP_HOST'],'images/','city'.$city_id.'.png','L',3,0,'#CC0000'));
