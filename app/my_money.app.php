...
$alipay_qubiema = $pay_row['alipay_qubiema'];
	?>
<body onLoad="javascript:document.alipay.submit()"><!--https://tradeexprod.alipay.com/cooperate/createTradeByBuyer.htm?partner=2088701920622911&out_trade_no=1224940715-->
...
/*	$riqi = trim($_POST['riqi']);*/
	...
	if($_POST)//检测有提交
	{//检测有提交
    /*if (preg_match("/[^0.-9]/",$cz_jine))*/if (preg_match("/[^0.-9]/",$card_sn))
    {
	$this->show_warning('cuowu_nishurudebushishuzilei'); 
    return;
    }
...
//$user_name=$this->visitor->get('user_name');
    ...
    /*if (preg_match("/[^0.-9]/",$cz_jine))*/if (preg_match("/[^0.-9]/",$duihuanjine))
    {
	$this->show_warning('cuowu_nishurudebushishuzilei'); 
    return;
    }
...
$canshu_row=$this->canshu_mod->can();
 ...
 $lv31=$canshu_row['lv31'];
	...
	if($_POST)//检测有提交
	{//检测有提交
    /*if (preg_match("/[^0.-9]/",$cz_jine))*/if (preg_match("/[^0.-9]/",$duihuanjifen))
    {
	$this->show_warning('cuowu_nishurudebushishuzilei'); 
    return;
    }
