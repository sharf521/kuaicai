$(function(){
    ...
    $("#set_price_interval").click(function(){
	 ...
	 /* 自定义积分价格区间 */
    $("#set_jfprice").click(function(){
        $("ul[ectype='ul_jfprice'] li").show();
        $(this).hide();
    });
	
	/* 自定义vip价格区间 */
    $("#set_vipprice").click(function(){
        $("ul[ectype='ul_vipprice'] li").show();
        $(this).hide();
    });
    ...
    $("ul[ectype='ul_region'] a").click(function(){
	 ...
	 $("ul[ectype='ul_jfprice'] a").click(function(){
        replaceParam('jifen_price', this.title);
        return false;
    });
    $("#search_by_jfprice").click(function(){
        replaceParam('jifen_price', $(this).siblings("input:first").val() + '-' + $(this).siblings("input:last").val());
        return false;
    });
	
	$("ul[ectype='ul_vipprice'] a").click(function(){
        replaceParam('vip_price', this.title);
        return false;
    });
    $("#search_by_vipprice").click(function(){
        replaceParam('vip_price', $(this).siblings("input:first").val() + '-' + $(this).siblings("input:last").val());
        return false;
    });
