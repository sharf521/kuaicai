...
FCKConfig.ToolbarSets["Default"] = [
	['Source','Preview','PasteText','PasteWord'],
	...
	['ShowBlocks','PageBreak','Codes','flvPlayer']	// No comma for the last row.
] ;
/*FCKConfig.ToolbarSets["Default"] = [
...
FCKConfig.ToolbarSets["Small"] = [
	...
	['Link','Unlink','Anchor','-','TextColor','BGColor','FitWindow']
...
FCKConfig.FontNames		= '宋体;黑体;幼圆;楷体;仿宋;Arial;Comic Sans MS;Courier New;Tahoma;Times New Roman;Verdana' ;
...
//FCKConfig.Plugins.Add('uploadfile', 'zh-cn');
FCKConfig.Plugins.Add('flvPlayer','zh-cn') ;
FCKConfig.Plugins.Add( 'Uploader','zh-cn') ;