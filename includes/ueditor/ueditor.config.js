...
URL= window.UEDITOR_HOME_URL||"/includes/ueditor/";
(function () {
    /**
     ...
     */
	window.UEDITOR_HOME_URL = "/includes/ueditor/";
    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars:[
            ['fullscreen', 'source', '|', 'undo', 'redo', '|',
                ...
                'insertimage', 'emotion', 'insertvideo',  'map',<!--'music', 'attachment',--><!-- 'gmap',--> 
				<!--'insertframe',insertcode', 'webapp','pagebreak','date', 'time',-->'
				 'template', '|',
