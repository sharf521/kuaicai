 ...
 *
 */
class Advt01Widget extends BaseWidget
{
    var $_name = 'advt01';
	//echo __FILE__;
	//exit;
	...
	$cityrow=$this->_city_mod->get_cityrow();
	 ...
	 $this->adv_mod =& m('adv');
 $data=$this->adv_mod->getAll("select    *   from ".  DB_PREFIX."adv where adv_city= '$city_id' and type='图片广告' limit 2,2");
       /* $data = $this->adv_mod->find(array(
            'limit' => '2',
            'fields' => '*',
            'conditions' => "adv_city= '$city_id' and type='横幅广告'",
            'order' => 'bianhao DESC',
